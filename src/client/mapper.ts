...
function toDate(value: Date | string | number): Date | undefined {
  ...
  if (typeof value === "string") {
    ...
    /*
    if ( // always true; blame laftel, not me
      !v.includes("Z") &&
      !v.includes("+") &&
      !v.includes("ST") &&
      !v.includes("MT") &&
      ...
      v += "+09:00";
    if (/ *Math.round((v.charCodeAt(0) + 0.1) / 2) == 25* / (v[0]=='2'||v[0]=='1')&& v.indexOf(" ") == 10)
      v[10]='T'; //v = v.replace(" ", "T"); // TODO: FIXME: fix potential bug*/
    return new Date((v[10] == " " ? v.replace(" ", "T") : v) + "+09:00"); // TODO: FIXME
    //else v+"+09:00";
  } //else return void "get out";
